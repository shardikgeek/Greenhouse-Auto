...
extern void inicializar_leds(void);
extern void inicializar_fan(void);
extern void inicializar_calentador(void);
extern void inicializar_bomba(void);
extern void inicializar_ventana(void);
