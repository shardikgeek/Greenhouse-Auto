...
/*LCD_2X16_t LCD_2X16[] = {
 // Name   ,PORT , PIN       , CLOCK              , Init
  {TLCD_RS ,GPIOE,GPIO_Pin_5 ,RCC_AHB1Periph_GPIOE,Bit_RESET},
  {TLCD_E  ,GPIOE,GPIO_Pin_6 ,RCC_AHB1Periph_GPIOE,Bit_RESET},
  {TLCD_D4 ,GPIOE,GPIO_Pin_7 ,RCC_AHB1Periph_GPIOE,Bit_RESET},
  {TLCD_D5 ,GPIOE,GPIO_Pin_8 ,RCC_AHB1Periph_GPIOE,Bit_RESET},
  {TLCD_D6 ,GPIOE,GPIO_Pin_9 ,RCC_AHB1Periph_GPIOE,Bit_RESET},
  {TLCD_D7 ,GPIOE,GPIO_Pin_10,RCC_AHB1Periph_GPIOE,Bit_RESET},
};*/

LCD_2X16_t LCD_2X16[] = {
 // Name   ,PORT , PIN       , CLOCK              , Init
  {TLCD_RS ,GPIOB,GPIO_Pin_4 ,RCC_AHB1Periph_GPIOB,Bit_RESET}, // marron
  {TLCD_E  ,GPIOB,GPIO_Pin_6 ,RCC_AHB1Periph_GPIOB,Bit_RESET}, // naranja
  {TLCD_D4 ,GPIOE,GPIO_Pin_0 ,RCC_AHB1Periph_GPIOE,Bit_RESET}, // amarillo
  {TLCD_D5 ,GPIOE,GPIO_Pin_2 ,RCC_AHB1Periph_GPIOE,Bit_RESET}, // azul
  {TLCD_D6 ,GPIOE,GPIO_Pin_4 ,RCC_AHB1Periph_GPIOE,Bit_RESET}, // gris
  {TLCD_D7 ,GPIOE,GPIO_Pin_6,RCC_AHB1Periph_GPIOE,Bit_RESET}, // verde
};
